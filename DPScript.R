...
#Answer: our main goal is to classify the instances acording to his demographic and banking features between two clases, fall in credit default or not fall in default
...
#this is the graph that we need to put in the report
