...
For each model that we realized to answer our question, there were no significant differences between the models in terms of the performance measures, The first one was Decesion Tree, the second one was Logistic and the last one was Neural Network.
...
A comparison between the 3 models:
